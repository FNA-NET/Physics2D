...
using Physics2D.Tools.Triangulation.Delaunay.Delaunay;
using Physics2D.Tools.Triangulation.Delaunay.Delaunay.Sweep;
using Microsoft.Xna.Framework;

namespace Physics2D.Tools.Triangulation.Delaunay
{
    /// <summary>
